...
export const DEFAULT_SKY_ATMOSPHERE_SETTINGS: SkyAtmosphereSettings = {
	sunIntensity: 34.0,
	rayleighStrength: 6.0,
	mieStrength: 14.0,
	ozoneStrength: 10.0,
	horizonOffset: 0.0,
	skyMultiplier: 2.8,
	daySkyStrength: 1.35,
	nightSkyStrength: 1.25,
	twilightStrength: 1.0,
	twilightAmberStrength: 1.0,
	twilightRoseStrength: 0.25,
	dayHorizonColor: "#1a5cff",
	dayZenithColor: "#01117a",
	nightHorizonColor: "#09132a",
	nightZenithColor: "#010309",
	twilightLowColor: "#050a25",
	twilightHighColor: "#0e1f4d",
	twilightAmberColor: "#ff6b21",
	twilightRoseColor: "#8c2e6b",
};
